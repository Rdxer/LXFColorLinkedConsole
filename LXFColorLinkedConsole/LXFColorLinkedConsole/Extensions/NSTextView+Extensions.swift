...
extension NSTextView {
    func kz_mouseDown(event: NSEvent) {
        ...
        guard let fileName = attr[LXFColorLinkedConsole.Strings.linkedFileName] as? String,
            let lineNumber = attr[LXFColorLinkedConsole.Strings.linkedLine] as? String,
    ...
    private func scrollTextView(textView: NSTextView, toLine line: Int) {
        ...
        var currentLine = 1
        var index = 0
        for ; index < text.length; currentLine += 1 {
